...
Window::Window (const int width, const int height, const int scale) {
	WIDTH = width;
	HEIGHT = height;
	SCALE = scale;
 ...
 */
void Window::update (void const* buffer) {
 ...
 */
bool Window::processInput (size_t* keys) {
	SDL_Event event;
	bool quit = false;
